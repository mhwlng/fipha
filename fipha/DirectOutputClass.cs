...
namespace fipha
{
    ...
    public sealed class DirectOutputClass
    {
        ...
        private const string DirectOutputDll = @"C:\Program Files\Logitech\DirectOutput\DirectOutput.dll";
        ...
        private static extern IntPtr DirectOutput_Deinitialize();
        public static ReturnValues Deinitialize() { return (ReturnValues)DirectOutput_Deinitialize(); }

        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_Initialize(StringBuilder wszAppName);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_RegisterDeviceCallback([MarshalAs(UnmanagedType.FunctionPtr)]DeviceCallback pfnCallback, IntPtr pvParam);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_Enumerate([MarshalAs(UnmanagedType.FunctionPtr)]EnumerateCallback pfnCallback, IntPtr pvParam);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_GetDeviceType(IntPtr hDevice, ref Guid pGuidType);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_GetSerialNumber(IntPtr hDevice, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder pszSerialNumber, uint dwSize);
        internal static ReturnValues GetSerialNumber(IntPtr hDevice, out string serialNumber)
        {
            var msg = new StringBuilder(16);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_RegisterPageCallback(IntPtr hDevice, [MarshalAs(UnmanagedType.FunctionPtr)]PageCallback pfnCallback, IntPtr pvParam);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_RegisterSoftButtonCallback(IntPtr hDevice, [MarshalAs(UnmanagedType.FunctionPtr)]SoftButtonCallback pfnCallback, IntPtr pvParam);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_AddPage(IntPtr hDevice, IntPtr dwPage, ref string wszName, IntPtr dwFlags);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_RemovePage(IntPtr hDevice, IntPtr dwPage);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_SetLed(IntPtr hDevice, IntPtr dwPage, IntPtr dwIndex, IntPtr dwValue);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_SetString(IntPtr hDevice, IntPtr dwPage, IntPtr dwIndex, IntPtr cchValue, ref string wszValue);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_SetImage(IntPtr hDevice, IntPtr dwPage, IntPtr dwIndex, IntPtr pbValue, IntPtr cbValue);
        ...
        [DllImport(DirectOutputDll, SetLastError = true)]
        private static extern IntPtr DirectOutput_SetImageFromFile(IntPtr hDevice, IntPtr dwPage, IntPtr dwIndex, IntPtr wszFilename, ref string cchFilename);
